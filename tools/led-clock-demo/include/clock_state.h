...
#define CLOCK_SECONDS_PER_LED (5UL)
#define CLOCK_MINUTES_PER_LED (5UL)
#define CLOCK_HOURS_PER_LED (1UL)
#define CLOCK_SECONDS_PER_MINUTE (60UL)
#define CLOCK_MINUTES_PER_HOUR (60UL)

#define CLOCK_TICKS_PER_SEC (10UL)
#define CLOCK_TICKS_PER_LED (CLOCK_TICKS_PER_SEC * CLOCK_SECONDS_PER_LED)
#define CLOCK_TICKS_PER_REVOLUTION (CLOCK_TICKS_PER_SEC * 60UL)
